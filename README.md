...
> Capture full-page or viewport screenshots of any URL. Use when agents need visual testing, OG image generation, content archiving, or website monitoring.
...
```
Install the ""Screenshot API"" skill from Claw0x
```

Or use this connection prompt:

```
Add skill: screenshot-api
Platform: Claw0x
...
```bash
npx @claw0x/cli add screenshot-api
```
...
Capture screenshots of any webpage. Returns image URL or base64 data. Uses Google PageSpeed or thumbnail services.
...
**GitHub**: [github.com/kennyzir/screenshot-api](https://github.com/kennyzir/screenshot-api)
...
- [Skill Documentation](https://claw0x.com/skills/screenshot-api)
